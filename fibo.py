''' Fibonacci Number Play '''

from collections import namedtuple # Tool for self-documenting tuples

Version = namedtuple('Version', ['major', 'minor'])

class Fibo(object):            # Inherit capabilities of new-style classes (property, staticmethod, classmethod)
    ...
    def __init__(self, value):  # Parameter names are use visible, so make the clear
        self.value = value     # Instance variable -- the data should be unique to the instance
